...
DEF_GUID("5996FC05-109C-48DE-808B-23FA0830B676", N_("Linux root verity signature (x86)")),
DEF_GUID("41092B05-9FC8-4523-994F-2DEF0408B176", N_("Linux root verity signature (x86-64)")),
DEF_GUID("D46495B7-A053-414F-80F7-700C99921EF8", N_("Linux root verity signature (Alpha)")),
DEF_GUID("143A70BA-CBD3-4F06-919F-6C05683A78BC", N_("Linux root verity signature (ARC)")),
DEF_GUID("42B0455F-EB11-491D-98D3-56145BA9D037", N_("Linux root verity signature (ARM)")),
DEF_GUID("6DB69DE6-29F4-4758-A7A5-962190F00CE3", N_("Linux root verity signature (ARM-64)")),
DEF_GUID("E98B36EE-32BA-4882-9B12-0CE14655F46A", N_("Linux root verity signature (IA-64)")),
DEF_GUID("5AFB67EB-ECC8-4F85-AE8E-AC1E7C50E7D0", N_("Linux root verity signature (LoongArch-64)")),
DEF_GUID("C919CC1F-4456-4EFF-918C-F75E94525CA5", N_("Linux root verity signature (MIPS-32 LE)")),
DEF_GUID("904E58EF-5C65-4A31-9C57-6AF5FC7C5DE7", N_("Linux root verity signature (MIPS-64 LE)")),
DEF_GUID("1B31B5AA-ADD9-463A-B2ED-BD467FC857E7", N_("Linux root verity signature (PPC)")),
DEF_GUID("F5E2C20C-45B2-4FFA-BCE9-2A60737E1AAF", N_("Linux root verity signature (PPC64)")),
DEF_GUID("D4A236E7-E873-4C07-BF1D-BF6CF7F1C3C6", N_("Linux root verity signature (PPC64LE)")),
DEF_GUID("3A112A75-8729-4380-B4CF-764D79934448", N_("Linux root verity signature (RISC-V-32)")),
DEF_GUID("EFE0F087-EA8D-4469-821A-4C2A96A8386A", N_("Linux root verity signature (RISC-V-64)")),
DEF_GUID("3482388E-4254-435A-A241-766A065F9960", N_("Linux root verity signature (S390)")),
DEF_GUID("C80187A5-73A3-491A-901A-017C3FA953E9", N_("Linux root verity signature (S390X)")),
DEF_GUID("B3671439-97B0-4A53-90F7-2D5A8F3AD47B", N_("Linux root verity signature (TILE-Gx)")),
DEF_GUID("974A71C0-DE41-43C3-BE5D-5C5CCD1AD2C0", N_("Linux /usr verity signature (x86)")),
DEF_GUID("E7BB33FB-06CF-4E81-8273-E543B413E2E2", N_("Linux /usr verity signature (x86-64)")),
DEF_GUID("5C6E1C76-076A-457A-A0FE-F3B4CD21CE6E", N_("Linux /usr verity signature (Alpha)")),
DEF_GUID("94F9A9A1-9971-427A-A400-50CB297F0F35", N_("Linux /usr verity signature (ARC)")),
DEF_GUID("D7FF812F-37D1-4902-A810-D76BA57B975A", N_("Linux /usr verity signature (ARM)")),
DEF_GUID("C23CE4FF-44BD-4B00-B2D4-B41B3419E02A", N_("Linux /usr verity signature (ARM-64)")),
DEF_GUID("8DE58BC2-2A43-460D-B14E-A76E4A17B47F", N_("Linux /usr verity signature (IA-64)")),
DEF_GUID("B024F315-D330-444C-8461-44BBDE524E99", N_("Linux /usr verity signature (LoongArch-64)")),
DEF_GUID("3E23CA0B-A4BC-4B4E-8087-5AB6A26AA8A9", N_("Linux /usr verity signature (MIPS-32 LE)")),
DEF_GUID("F2C2C7EE-ADCC-4351-B5C6-EE9816B66E16", N_("Linux /usr verity signature (MIPS-64 LE)")),
DEF_GUID("7007891D-D371-4A80-86A4-5CB875B9302E", N_("Linux /usr verity signature (PPC)")),
DEF_GUID("0B888863-D7F8-4D9E-9766-239FCE4D58AF", N_("Linux /usr verity signature (PPC64)")),
DEF_GUID("C8BFBD1E-268E-4521-8BBA-BF314C399557", N_("Linux /usr verity signature (PPC64LE)")),
DEF_GUID("C3836A13-3137-45BA-B583-B16C50FE5EB4", N_("Linux /usr verity signature (RISC-V-32)")),
DEF_GUID("D2F9000A-7A18-453F-B5CD-4D32F77A7B32", N_("Linux /usr verity signature (RISC-V-64)")),
DEF_GUID("17440E4F-A8D0-467F-A46E-3912AE6EF2C5", N_("Linux /usr verity signature (S390)")),
DEF_GUID("3F324816-667B-46AE-86EE-9B0C0C6C11B4", N_("Linux /usr verity signature (S390X)")),
DEF_GUID("4EDE75E2-6CCC-4CC8-B9C7-70334B087510", N_("Linux /usr verity signature (TILE-Gx)")),
