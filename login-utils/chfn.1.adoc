...
*chfn* [*-f* _full-name_] [*-o* _office_] [*-p* _office-phone_] [*-h* _home-phone_] [*-u*] [*-V*] [_username_|_UID_]
...
+
The boolean setting *"yes"* means that only the _Office_, _Office Phone_ and _Home Phone_ fields are changeable, and boolean setting *"no"* means that also the _Full Name_ is changeable.
+
...
--
+
For example, *CHFN_RESTRICT "wh"* allows changing work and home phone numbers.
+
