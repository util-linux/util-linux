...
This command will work only if the filesystem has support for freezing. List of these filesystems include (2026-09-08) *btrfs*, *ext2/3/4*, *f2fs*, *gfs2*, *jfs*, *nilfs2*, and *xfs*. Previous list may be incomplete, as more filesystems get support. If in doubt easiest way to know if a filesystem has support is create a small loopback mount and test freezing it.
