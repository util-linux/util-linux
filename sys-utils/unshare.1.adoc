...
+
By default, *systemd-nsresourced.service*(8) maps the current user and group IDs to themselves, as *--map-current-user* would. Use *--map-root-user* to map them to root instead.
+
