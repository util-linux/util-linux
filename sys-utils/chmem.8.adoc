...
Configure memory blocks for a Linux instance other than the instance from which the *chmem* command is issued. The specified _directory_ is the system root of the Linux instance to be configured.
