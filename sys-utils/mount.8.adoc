...
*X-mount.idmap*=__id-type__:__id-host__:__id-mount__:__id-range__ [__id-type__:__id-host__:__id-mount__:__id-range__], *X-mount.idmap*=__file__::
...
+
The ID-mapping must be specified using the syntax __id-type__:__id-host__:__id-mount__:__id-range__.
...
UID 1000 is mapped to UID 0, GID 1001 is mapped to GID 1, GID 1002 is mapped to GID 2, UID and GID 5000 are mapped to 1000, and UID and GID 5001 are mapped to 1001 in the mount.
+
