...
If set, configures *agetty* to sleep _delay_ seconds before opening the tty. Similar to the *--delay* option.

*agetty.hangup*::

If the file exists, configures *agetty* to do a virtual hangup of the specified terminal. Similar to the *--hangup* option.
...
If the file exists, configures *agetty* to not clear the screen before prompting for the login name. Similar to the *--noclear* option.

*agetty.nohints*::

If the file exists, configures *agetty* to not print hints about Num, Caps and Scroll Locks. Similar to the *--nohints* option.

*agetty.nohostname*::

If the file exists, configures *agetty* to show no hostname. Similar to the *--nohostname* option.

*agetty.noissue*::

If the file exists, configures *agetty* to not show contents of */etc/issue* before writing the login prompt. Similar to the *--noissue* option.
