...
TS_CMD_CHCPU=${TS_CMD_CHCPU:-"${ts_commandsdir}chcpu"}
...
TS_CMD_FDSEND=${TS_CMD_FDSEND-"${ts_commandsdir}fdsend"}
TS_CMD_FDRECV=${TS_CMD_FDRECV-"${ts_commandsdir}fdrecv"}
...
TS_CMD_FSTRIM=${TS_CMD_FSTRIM-"${ts_commandsdir}fstrim"}
