...
*-c*, *--copy*::
Copy files instead of renaming them. The original files remain unchanged. For regular files, the content is copied; for symbolic links, a new link with the same target is created.
